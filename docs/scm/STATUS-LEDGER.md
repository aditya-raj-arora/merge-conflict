...
| ---------------------------------------------------- | ------------------------------------------------------ | ----------------------------------- | ------------------------------------------------------------------ | -------- |
| CSCI-MC (whole app)                                  | `v0.10.5` / `BL-24-ch06-5-questions-project-brief`     | staging + prod (both verified live) | 2026-09-03, Chapter 6 5-question redesign + project brief (CR-117) | —        |
