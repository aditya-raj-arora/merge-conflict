...
| -------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------ | --------------------------------------------- | -------- |
| CSCI-MC (whole app)                                | `v0.7.0` / `BL-09-branching-story-mechanic` | staging + prod (both verified live)                    | 2026-09-01, branching story mechanic (CR-091) | —        |
...
| TLCSC-04-CONTENT > LLCSC-04-01-CH01 (STORY-01-01)  | `_r1` (supersedes retired LVL-01-01)        | staging + prod                                         | 2026-09-01                                    | —        |
| TLCSC-01-ENGINE > LLCSC-01-02-MECHANICS > story.ts | `_r1` (new)                                 | staging + prod                                         | 2026-09-01                                    | —        |
| TLCSC-04-CONTENT > LLCSC-04-02-CH02 (LVL-02-01)    | `_r1`                                       | staging + prod (now reachable via level-select, BL-04) | 2026-08-20                                    | —        |
