...
| ---------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------ | -------- |
| CSCI-MC (whole app)                                  | `v0.9.0` / `BL-16-progression-budget-economy`                   | staging + prod (both verified live) | 2026-09-03, level progression + budget economy + player profile (CR-109) | —        |
| TLCSC-02-UI > LevelSelect                            | `_r2` (unlock gating, passed/locked badges, name+budget header) | staging + prod                      | 2026-09-03                                                               | —        |
