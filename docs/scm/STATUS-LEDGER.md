...
| ---------------------------------------------------- | ------------------------------------------------------ | ----------------------------------- | -------------------------------------------------------------------------- | -------- |
| CSCI-MC (whole app)                                  | `v0.10.0` / `BL-19-ch03-5-questions-project-brief`     | staging + prod (both verified live) | 2026-09-03, project-brief framing + Chapter 3 5-question redesign (CR-112) | —        |
