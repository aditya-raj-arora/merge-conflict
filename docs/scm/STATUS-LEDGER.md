...
| ---------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------- | -------- |
| CSCI-MC (whole app)                                  | `v0.12.0` / `BL-27-inspectable-graph`               | prod (verified live); staging not deployed - see BL-27 | 2026-09-04, Inspectable graph + Ch5 inspection redesign (CR-120/121) | —        |
...
| TLCSC-02-UI > StoryView                              | `_r5` (adds graph inspection state)                 | prod (staging pending - see BL-27)                     | 2026-09-04                                                           | —        |
