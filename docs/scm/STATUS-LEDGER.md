...
| ---------------------------------------------------- | ---------------------------------------------------- | ----------------------------------- | -------------------------------------------------------------- | -------- |
| CSCI-MC (whole app)                                  | `v0.11.1` / `BL-26-graph-legibility`                 | staging + prod (both verified live) | 2026-09-04, Graph label legibility + progression copy (CR-119) | —        |
...
| TLCSC-02-UI (GraphCanvas)                            | `_r2` (label legibility: colour, bounds, collisions) | staging + prod                      | 2026-09-04                                                     | —        |
...
| TLCSC-04-CONTENT > LLCSC-04-05-CH05 (STORY-05-01)    | `_r2` (5-question redesign; supersedes prior `_r1`)  | staging + prod                      | 2026-09-03                                                     | —        |
