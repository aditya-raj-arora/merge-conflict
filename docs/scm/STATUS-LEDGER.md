...
| ---------------------------------------------------- | ------------------------------------------------------ | ----------------------------------- | ---------------------------------------------------------------------------- | -------- |
| CSCI-MC (whole app)                                  | `v0.9.2` / `BL-18-title-screen-next-level`             | staging + prod (both verified live) | 2026-09-03, title screen + last-played memory + Next Level shortcut (CR-111) | —        |
