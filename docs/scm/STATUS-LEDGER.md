...
| ---------------------------------------------------- | --------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------- | -------- |
| CSCI-MC (whole app)                                  | `v0.11.0` / `BL-25-tiered-progression-money-gated`  | staging + prod (both verified live) | 2026-09-03, Tiered progression gated on money earned (CR-118) | —        |
