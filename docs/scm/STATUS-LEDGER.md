...
| ---------------------------------------------------- | ------------------------------------------------------ | ----------------------------------- | ------------------------------------------------------------------ | -------- |
| CSCI-MC (whole app)                                  | `v0.10.1` / `BL-20-ch01-5-questions-project-brief`     | staging + prod (both verified live) | 2026-09-03, Chapter 1 5-question redesign + project brief (CR-113) | —        |
